...
public class CompareObjects {
    ...
    public static boolean compareToStringObj(Object object1, Object object2) {
        return object1.getClass().toString().equals(object2.getClass().toString());
    }

    public static boolean compareHashCodeObj(Object object1, Object object2) {
        return object1.getClass().toString().length() == object2.getClass().toString().length();
    }
}
